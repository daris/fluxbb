...
?>
	<div class="blockform">
		<h2><span><?php echo $lang->t('Parser head') ?></span></h2>
		<div class="box">
			<form method="post" action="admin_parser.php" enctype="multipart/form-data">
				<p class="submittop">
					<input type="submit" name="save" value="<?php echo $lang->t('Save changes') ?>" />
					<input type="submit" name="reset" value="<?php echo $lang->t('reset defaults') ?>" />
				</p>
				<div class="inform">
					<input type="hidden" name="form_sent" value="1" />
					<fieldset>
						<legend><?php echo $lang->t('Config subhead') ?></legend>
						<div class="infldset">
							<table class="aligntop" cellspacing="0">

								<tr>
									<th scope="row"><?php echo $lang->t('syntax style') ?></th>
									<td colspan="2">
...
?>
									...
									<td><span><?php echo $lang->t('syntax style help') ?></span></td>
								</tr>
								<tr>
									<th scope="row"><?php echo $lang->t('textile') ?></th>
									<td colspan="2">
										<input type="radio" name="config[textile]" value="1"<?php if ($config['textile']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('Yes') ?></strong>   <input type="radio" name="config[textile]" value="0"<?php if (!$config['textile']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('No') ?></strong>
									</td>
									<td>
										<span><?php echo $lang->t('textile help') ?></span>
									</td>
								</tr>
								<tr>
									<th scope="row"><?php echo $lang->t('quote_links') ?></th>
									<td colspan="2">
										<input type="radio" name="config[quote_links]" value="1"<?php if ($config['quote_links']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('Yes') ?></strong>   <input type="radio" name="config[quote_links]" value="0"<?php if (!$config['quote_links']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('No') ?></strong>
									</td>
									<td>
										<span><?php echo $lang->t('quote_links help') ?></span>
									</td>
								</tr>
								<tr>
									<th scope="row"><?php echo $lang->t('quote_imgs') ?></th>
									<td colspan="2">
										<input type="radio" name="config[quote_imgs]" value="1"<?php if ($config['quote_imgs']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('Yes') ?></strong>   <input type="radio" name="config[quote_imgs]" value="0"<?php if (!$config['quote_imgs']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('No') ?></strong>
									</td>
									<td>
										<span><?php echo $lang->t('quote_imgs help') ?></span>
									</td>
								</tr>
								<tr>
									<th scope="row"><?php echo $lang->t('click_imgs') ?></th>
									<td colspan="2">
										<input type="radio" name="config[click_imgs]" value="1"<?php if ($config['click_imgs']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('Yes') ?></strong>   <input type="radio" name="config[click_imgs]" value="0"<?php if (!$config['click_imgs']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('No') ?></strong>
									</td>
									<td>
										<span><?php echo $lang->t('click_imgs help') ?></span>
									</td>
								</tr>

								<tr>
									<th scope="row"><?php echo $lang->t('valid_imgs') ?></th>
									<td colspan="2">
										<input type="radio" name="config[valid_imgs]" value="1"<?php if ($config['valid_imgs']) echo ' checked="checked"'; if (!ini_get('allow_url_fopen')) echo(' disabled="disabled" title="'. htmlspecialchars($lang->t('unavailable')) .'"'); ?> /> <strong><?php echo $lang->t('Yes') ?></strong>
										<input type="radio" name="config[valid_imgs]" value="0"<?php if (!$config['valid_imgs']) echo ' checked="checked"'; if (!ini_get('allow_url_fopen')) echo(' disabled="disabled" title="'. htmlspecialchars($lang->t('unavailable')) .'"'); ?> /> <strong><?php echo $lang->t('No') ?></strong>
									</td>
									<td><?php echo $lang->t('valid_imgs help') ?></td>
								</tr>
								<tr>
									<th scope="row"><?php echo $lang->t('max_size') ?></th>
									<td colspan="2">
										<input type="text" name="config[max_size]" size="10" maxlength="8" value="<?php echo($config['max_size'])?>"<?php if (!ini_get('allow_url_fopen')) echo(' disabled="disabled" title="'. htmlspecialchars($lang->t('unavailable')) .'"'); ?> />
									</td>
									<td><span><?php echo $lang->t('max_size help') ?></span></td>
								</tr>
								<tr>
									<th scope="row"><?php echo $lang->t('def_xy') ?></th>
									<td>
									...
									<td>
										<span><?php echo $lang->t('def_xy help') ?></span>
									</td>
								</tr>
								...
								<tr>
									<th scope="row"><?php echo $lang->t('max_xy') ?></th>
									<td>
									...
									<td><?php echo $lang->t('max_xy help') ?></td>
								</tr>

								<tr>
									<th scope="row"><?php echo $lang->t('smiley_size') ?></th>
									<td colspan=2>
										<input type="text" name="config[smiley_size]" size="5" maxlength="5" value="<?php echo $config['smiley_size'] .'%' ?>" />
									</td>
									<td>
										<span><?php echo $lang->t('smiley_size help') ?></span>
									</td>
								</tr>
				...
				<div class="inform">
					<fieldset>
						<legend><?php echo $lang->t('Smilies subhead') ?></legend>
						<div class="infldset">
							<table cellspacing="0">
							<thead>
								<tr>
									<th scope="col"><?php echo $lang->t('smiley_text_label') ?></th>
									<th scope="col"><?php echo $lang->t('smiley_file_label') ?></th>
									<th scope="col">:)</th>
								</tr>
							</thead>
							<tbody>
...
?>
								...
								<tr>
									<th scope="row"><?php echo($lang->t('smiley_upload')); ?></th>
 <?php if (ini_get('file_uploads')) { ?>
									...
									<td><input type="submit" name="upload" value="<?php echo($lang->t('upload_button')); ?>" /></td>
<?php } else { ?>
									<td colspan="2"><?php echo($lang->t('upload_off')); ?></td>
<?php } ?>
								</tr>
							</tbody>
							</table>
				...
				<div class="inform">
					<fieldset>
						<legend><?php echo $lang->t('BBCodes subhead') ?></legend>
						<div class="infldset">
							<table cellspacing="0">
							<thead>
								<tr>
									<th class="tcl" scope="col"><?php echo $lang->t('tagname_label') ?></th>
									<th class="tc3" scope="col"><?php echo $lang->t('in_post_label') ?></th>
									<th class="hidehead" scope="col"><?php echo $lang->t('in_sig_label') ?></th>
									<th class="tc2" scope="col"><?php echo $lang->t('depth_max') ?></th>
								</tr>
							</thead>
							<tbody>
<?php
...
/*
									<th class="tc2" scope="col"><?php echo $lang->t('tagtype_label') ?></th>
...
*/
 ?>
								<tr>
									...
									<td>
										<input type="radio" name="<?php echo($tagname) ?>_in_post" value="1"<?php if ($bbcd[$tagname]['in_post']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('Yes') ?></strong>   <input type="radio" name="<?php echo($tagname) ?>_in_post" value="0"<?php if (!$bbcd[$tagname]['in_post']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('No') ?></strong>
									</td>
									<td>
										<input type="radio" name="<?php echo($tagname) ?>_in_sig" value="1"<?php if ($bbcd[$tagname]['in_sig']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('Yes') ?></strong>   <input type="radio" name="<?php echo($tagname) ?>_in_sig" value="0"<?php if (!$bbcd[$tagname]['in_sig']) echo ' checked="checked"' ?> /> <strong><?php echo $lang->t('No') ?></strong>
									</td>
									<td>
